...
class Transaction():
    ...
    def Broadcast(self):
        import p2p
        p2p.Node.broadcast(bc_enum.Service.SERVICE*bc_enum.Network.SYNCHRONIZATION+bc_enum.Synchronization.TRANSACTIONFROM, self.pb2)
    @staticmethod
    def loadtxs(txshash):
            ...
            try:
                while True:
                    ...
                    if itemTuple[1]=="":
                        ...
                        p2p.Node.broadcast(bc_enum.Service.SERVICE*bc_enum.Network.SYNCHRONIZATION+bc_enum.Synchronization.TRANSACTIONFROM,msg)
            except Exception as e:
                pass
    @staticmethod
